            ...
            <div class="card shadow-lg border-0">
                <div class="card-header bg-gradient-success text-white py-3">
                    <div class="d-flex align-items-center">
                        <i class="fas fa-chalkboard-teacher me-3 fs-4"></i>
                        <div>
                            <h4 class="mb-0 fw-bold">Export Teachers Data</h4>
                            <p class="mb-0 opacity-75">Generate and download teacher reports with comprehensive filtering</p>
                        </div>
                    </div>
                </div>

                <div class="card-body p-4">
                    <form id="exportForm" action="{{ route('school.export.teachers.export') }}" method="POST">
                        @csrf
                        ...
                        <div class="row mb-4">
                            <div class="col-12">
                                <label class="form-label fw-semibold mb-3">
                                    <i class="fas fa-file-export me-2 text-success"></i>Export Format
                                </label>
                                <div class="row g-3">
                                    <div class="col-md-4">
                            ...
                            <div class="col-12">
                                <div class="d-flex align-items-center mb-3">
                                    <h5 class="mb-0 fw-semibold">
                                        <i class="fas fa-filter me-2 text-success"></i>Advanced Filters
                                    </h5>
                                    ...
                                    <div class="card bg-light border-0">
                                        <div class="card-body">
                                            <div class="row g-3">
                                                ...
                                                <div class="col-md-6">
                                                    <label class="form-label fw-semibold">
                                                        <i class="fas fa-users me-1"></i>Class Teacher
                                                    </label>
                                                    <select class="form-select" name="is_class_teacher">
                                                        <option value="">All Teachers</option>
                                                        <option value="1">Class Teachers Only</option>
                                                        <option value="0">Subject Teachers Only</option>
                                                    </select>
                                                </div>
                                ...
                                <div class="alert alert-success border-0 bg-success bg-opacity-10">
                                    <div class="d-flex align-items-center">
                                        ...
                                        <div>
                                            ...
                                            <span id="exportInfo">All teachers will be exported with their subjects and qualifications.</span>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-12">
                                <div class="d-flex gap-3 justify-content-end">
                                    ...
                                    <button type="submit" class="btn btn-success btn-lg px-4" id="exportBtn">
                                        <i class="fas fa-download me-2"></i>Export Teachers
                                    </button>
                                </div>
                            </div>
                        </div>
        ...
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">
                    <i class="fas fa-eye me-2"></i>Teachers Data Preview
                </h5>
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" id="proceedExport">
...
document.addEventListener('DOMContentLoaded', function() {
        ...
        setTimeout(() => {
            ...
            document.getElementById('previewContent').innerHTML = `
                <div class="text-center py-4">
                    ...
                    <p class="mt-2">Loading teachers preview data...</p>
                </div>
            `;
        }, 1500);
    });
    ...
    exportForm.addEventListener('submit', function(e) {
        ...
        setTimeout(() => {
            exportBtn.innerHTML = '<i class="fas fa-download me-2"></i>Export Teachers';
